                            ...
                            <CardContent>
                                ...
                                <div>
                                    ...
                                    <div className="input-field">
                                        <TextField label="Имя" fullWidth variant="outlined" placeholder="Введите имя"
                                                   id="name"
                                    ...
                                    <div className="input-field">
                                        <TextField label="Отчество" fullWidth variant="outlined"
                                                   placeholder="Введите отчество"
                                                   id="midname"
                                                   type="text" name="midname" value={form.midname}
                                                   onChange={changeHandler}/>
                                    </div>
                                    ...
                                    <div className="input-field">
                                        <TextField label="Логин" fullWidth variant="outlined"
                                    ...
                                    <div className="input-field">
                                        <TextField label="Пароль" fullWidth variant="outlined"
